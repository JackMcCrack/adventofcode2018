...
while  cartsremain > 1: 
    ...
    for i in range(len(carts)):
        ...
        for j in range(len(carts)):
            if j != i and carts[j].y == carts[i].y and carts[j].x == carts[i].x and carts[j].crashed == 0 and carts[i].crashed == 0:
                crash += 1
                cartsremain -= 2
                carts[i].crash()
                carts[j].crash()
...
for i in range(len(carts)):
    if carts[i].crashed == 0:
        print('LAST: ', carts[i].x,'x', carts[i].y, tick)
